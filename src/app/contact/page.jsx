          ...
          <div className="border border-neutral-300 px-6 py-8 first:rounded-t-2xl last:rounded-b-2xl">
            <fieldset>
              ...
              <div className="mt-6 grid grid-cols-1 gap-8 sm:grid-cols-2">
                <RadioInput label="$1K – $10K" name="budget" value="10" />
                <RadioInput label="$10K – $50K" name="budget" value="50" />
                <RadioInput label="$50K – $100K" name="budget" value="100" />
                <RadioInput label="More than $100K" name="budget" value="101" />
              </div>
            </fieldset>
          </div>
        </div>
    ...
    <FadeIn>
      ...
      <Border className="mt-16 pt-16">
        ...
        <dl className="mt-6 grid grid-cols-1 gap-8 text-sm sm:grid-cols-2">
          {[
            ['Careers', 'careers@motstudio.dev'],
            ['Press', 'press@motstudio.dev'],
          ].map(([label, email]) => (
            <div key={email}>
